...
class PokemonTest(unittest.TestCase):
    def setUp(self):
        ...
        self.pokemon_gengar = PokemonSchema().load(
            {
                "name_pokemon": "gengar",
                "picture_pokemon": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/94.png",
            }
        )
    ...
    def test_pokemon_search_full_name(self):
        ...
        found_pokemon = search_pokemons_by_name(
            search_pokemon_name=search_pokemon_full_name, pokedex=self.pokemons_results
        )
    ...
    def test_pokemon_search_partial_name(self):
        ...
        found_pokemons = search_pokemons_by_name(
            search_pokemon_name=search_pokemon_partial_name,
            pokedex=self.pokemons_results,
        )
